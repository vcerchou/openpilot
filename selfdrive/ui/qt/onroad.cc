...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  ic_turn_signal_l = loadPixmap("../assets/images/turn_signal_l.png");
  ic_turn_signal_r = loadPixmap("../assets/images/turn_signal_r.png");
}
...
void AnnotatedCameraWidget::updateState(const UIState &s) {
  ...
  steerAngle = car_state.getSteeringAngleDeg();
  ...
  maxTempC = ds.getMaxTempC();
  fanSpeed = ds.getFanSpeedPercentDesired();
